...
// ⬇️ ImagePreview component inside the same file
function ImagePreview({ onSelectImage }) {
  ...
  const openGallery = async () => {
    ...
    if (!result.canceled) {
      ...
      onSelectImage(result.assets[0].uri); // Send selected image back to parent
    }
  };
  ...
  async function takePhoto() {
    if (cameraRef.current) {
      try {
        ...
        setSelectedImageUri(photo.uri); // Optionally use this image
